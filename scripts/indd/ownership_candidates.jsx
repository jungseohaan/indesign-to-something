...
function _isSimpleMarkerLabelTextForOwnership(text) {
    ...
    if (text.length === 1) {
        ...
        if (_isSingleMarkerSymbolCodeForOwnership(code)) return true;
    }
    return false;
}

function _isSingleMarkerSymbolCodeForOwnership(code) {
...
function _pushExtractionCandidate(candidates, seen, passId, item, attrs) {
    ...
    candidates.push({
        ...
        atomicSourceObjectIds: attrs.atomicSourceObjectIds || [],
        atomicVisualSourceObjectIds: attrs.atomicVisualSourceObjectIds || [],
        atomicOwnedTextFrameIds: attrs.atomicOwnedTextFrameIds || [],
        atomicExportTargetObjectIds: attrs.atomicExportTargetObjectIds || [],
        atomicTextlessVectorContent: attrs.atomicTextlessVectorContent === true,
