...
function _buildExtractionPasses() {
    return [
        ...
        { id: "pass.page_textless_graphic_groups", phase: "06b_pageTextlessGroups", executor: "exportDecorationGroups", unit: "PAGE_GRAPHIC_GROUP", mode: "TEXTLESS_CANDIDATE", candidatePurpose: "CONTENT_CANDIDATE", mayHideText: true, outputDir: "rendered_frames" },
