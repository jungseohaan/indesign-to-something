...
function _sourceItemPreviewRow(src) {
    ...
    return {
        id: src.id,
        sourcePageIndex: src.sourcePageIndex !== undefined ? src.sourcePageIndex : null,
        ...
        pageRelativeBounds: src.pageRelativeBounds || null,
        geometricBounds: src.geometricBounds || null,
        pageRelativeGeometricBounds: src.pageRelativeGeometricBounds || null,
        visibleBounds: src.visibleBounds || null,
        pageRelativeVisibleBounds: src.pageRelativeVisibleBounds || null,
        pathBounds: src.pathBounds || null,
